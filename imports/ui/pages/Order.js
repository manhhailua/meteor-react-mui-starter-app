  ...
  render() {
    return (
      <Paper>
        ...
        <Content>
          <h1>Order Page</h1>
          <p>Pellentesque eu iaculis urna, sit amet suscipit tortor. Etiam maximus leo et ante
            ...
            turpis, vel lacinia arcu arcu in est. Fusce vel nulla eget mauris ultrices sodales.</p>
        </Content>
        <BottomBar />
      </Paper>
    );
